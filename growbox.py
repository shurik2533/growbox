...
def main():
    ...
    try:
        ...
        schedule.every().day.at("12:30").do(jobqueue.put, watering_controller_top.control)
        schedule.every().day.at("12:30").do(jobqueue.put, watering_controller_bottom.control)
        schedule.every().day.at("15:30").do(jobqueue.put, watering_controller_top.control)
        schedule.every().day.at("15:30").do(jobqueue.put, watering_controller_bottom.control)
